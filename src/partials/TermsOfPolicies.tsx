...
const TermsOfPolicies = () => {
  const str = `
  ## 제1장 총칙
  <br />
  ### 제1조(목적)    
   이 약관은 "링클립 서비스"(이하 "서비스"라고 한다)가 온라인으로 제공하는 디지털콘텐츠(이하 "콘텐츠"라고 한다) 및 제반서비스의 이용과 관련하여 서비스와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다. 
<br /><br />
  ### 제2조(정의)    
 ...
 6. "이름"이라 함은 "회원"의 식별과 서비스이용을 위하여 "회원"이 정하고 "회사"가 승인하는 문자 또는 숫자의 조합을 말합니다. 
 ...
 ② "회사"는 컴퓨터 등 정보통신설비의 보수점검, 교체 및 고장, 통신두절 또는 운영상 상당한 이유가 있는 경우 콘텐츠서비스의 제공을 일시적으로 중단할 수 있습니다. 
 ...
 <br /><br />
  ...
  return (
    <div className="h-60 overflow-y-scroll text-left mb-4">
